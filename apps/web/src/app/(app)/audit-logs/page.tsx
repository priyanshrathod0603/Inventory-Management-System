...
export default function AuditLogsPage() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="Audit Logs"
        description="Comprehensive immutable activity log of all user actions, logins, and system changes."
        breadcrumbs={[
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-xs overflow-hidden">
        ...
        <div className="p-12 text-center">
          ...
          <h3 className="text-sm font-semibold text-slate-900">No audit log entries</h3>
